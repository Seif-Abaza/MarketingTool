...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionWhatsApp = QAction(MainWindow)
        self.actionWhatsApp.setObjectName(u"actionWhatsApp")
        self.actionFacebook = QAction(MainWindow)
        self.actionFacebook.setObjectName(u"actionFacebook")
        self.actionGoogle_Youtube = QAction(MainWindow)
        self.actionGoogle_Youtube.setObjectName(u"actionGoogle_Youtube")
        self.actionGoogle_Youtube.setEnabled(False)
        self.actionInstegram = QAction(MainWindow)
        self.actionInstegram.setObjectName(u"actionInstegram")
        self.actionInstegram.setEnabled(False)
        self.actionVK = QAction(MainWindow)
        self.actionVK.setObjectName(u"actionVK")
        self.actionVK.setEnabled(False)
        self.actionOdnoklassniki = QAction(MainWindow)
        self.actionOdnoklassniki.setObjectName(u"actionOdnoklassniki")
        self.actionOdnoklassniki.setEnabled(False)
        self.actionTwitter = QAction(MainWindow)
        self.actionTwitter.setObjectName(u"actionTwitter")
        ...
        self.menuReset_Login = QMenu(self.menuAbout)
        self.menuReset_Login.setObjectName(u"menuReset_Login")
        ...
        self.menuAbout.addAction(self.menuReset_Login.menuAction())
        self.menuReset_Login.addAction(self.actionTelegram)
        self.menuReset_Login.addAction(self.actionWhatsApp)
        self.menuReset_Login.addAction(self.actionFacebook)
        self.menuReset_Login.addAction(self.actionGoogle_Youtube)
        self.menuReset_Login.addAction(self.actionInstegram)
        self.menuReset_Login.addAction(self.actionVK)
        self.menuReset_Login.addAction(self.actionOdnoklassniki)
        self.menuReset_Login.addAction(self.actionTwitter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionWhatsApp.setText(QCoreApplication.translate("MainWindow", u"WhatsApp", None))
        self.actionFacebook.setText(QCoreApplication.translate("MainWindow", u"Facebook", None))
        self.actionGoogle_Youtube.setText(QCoreApplication.translate("MainWindow", u"Google & Youtube", None))
        self.actionInstegram.setText(QCoreApplication.translate("MainWindow", u"Instegram", None))
        self.actionVK.setText(QCoreApplication.translate("MainWindow", u"VK", None))
        self.actionOdnoklassniki.setText(QCoreApplication.translate("MainWindow", u"Odnoklassniki", None))
        self.actionTwitter.setText(QCoreApplication.translate("MainWindow", u"Twitter", None))
        ...
        self.menuReset_Login.setTitle(QCoreApplication.translate("MainWindow", u"Reset Login", None))
