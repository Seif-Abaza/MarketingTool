...
class Settings(SettingsDialog, QDialog):
    ...
    def __init__(self, parent=None, Setting=None):
        ...
        if not self.settings is None:
            if self.settings.value(SETTINGS_KEYS_TO_ELEMENT_KEYS[6]):
                self.comLang.setCurrentText(
                    self.settings.value(SETTINGS_KEYS_TO_ELEMENT_KEYS[6])
                )
            else:
                self.comLang.setCurrentText(Language[0])

            self.txtOutput.setText(
                self.settings.value(SETTINGS_KEYS_TO_ELEMENT_KEYS[0])
            )
            self.txtTG_ID.setText(self.settings.value(SETTINGS_KEYS_TO_ELEMENT_KEYS[1]))
            self.txtTG_Hash.setText(
                self.settings.value(SETTINGS_KEYS_TO_ELEMENT_KEYS[2])
            )
            self.txtTG_Phone.setText(
                self.settings.value(SETTINGS_KEYS_TO_ELEMENT_KEYS[3])
            )
            self.txtFB_User.setText(
                self.settings.value(SETTINGS_KEYS_TO_ELEMENT_KEYS[4])
            )
            self.txtFB_Pass.setText(
                self.settings.value(SETTINGS_KEYS_TO_ELEMENT_KEYS[5])
            )
    ...
    def on_change_language(self):
        ...
        self.settings.setValue(SETTINGS_KEYS_TO_ELEMENT_KEYS[6], language)
